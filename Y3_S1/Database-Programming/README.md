...
* **Project I: Attendance Management System Backend** 
...
* **Assignment 1: Hostel Management Database Implementation**
  * Formulated a backend configuration for room allocations, payments, and maintenance lifecycle management.
...
* **Lab 1: Performance Tuning & B-Tree Indexes**
...
* **Project II: Delivery Records Tracking System**
...
* **Lab 2: Clinic Appointment Operations**
